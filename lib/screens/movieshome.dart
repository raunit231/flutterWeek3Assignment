...
import 'package:movies_app/screens/loginpage.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        colors: [Color(0xff6daba2), Colors.white])),
        child: Padding(
            ...
            drawer: Container(
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      ...
                      colors: [Color(0xff5b8b85), Colors.white])),
              child: Drawer(
                backgroundColor:Colors.transparent ,
                elevation: 0,
                child: ListView(
...
Widget text(String txt){
  return Padding(
    ...
    child: Text(txt,style: TextStyle(fontFamily: "Montserrat",fontSize: 30),),
  );
}
